---
name: readme-sync
description: Mantém o README.md em dia com o código. Use SEMPRE ao terminar qualquer mudança neste projeto que altere comportamento, arquitetura, estrutura de arquivos, dependências, scripts do npm ou o schema de efeitos — antes de dar a tarefa por concluída. Também use quando pedirem "atualiza o readme", "documenta isso" ou ao revisar se a documentação ainda bate com o código.
---
