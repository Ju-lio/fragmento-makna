...
export const PRESETS = {
  ...
  // `satisfies` mantém as chaves literais (então `PRESETS['fade-up']` é
  // conhecido em tempo de tipo) e ainda assim confere cada preset contra o
  // schema — um `prop` ou `ease` inválido aqui vira erro de compilação, não
  // um efeito que silenciosamente não anima nada.
