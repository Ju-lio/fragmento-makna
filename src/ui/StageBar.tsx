...
import { RESOLUTIONS } from '../engine/project.ts';
...
export function StageBar({ project, onResize }: StageBarProps) {
  ...
  const pickResolution = (e: React.ChangeEvent<HTMLSelectElement>) => {
...
const clampDim = (v: string) => Math.max(16, Math.min(7680, parseInt(v, 10) || 16));
